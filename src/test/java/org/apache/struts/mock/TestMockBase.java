...
public class TestMockBase extends TestCase {
    ...
    protected void setUpDefaultApp() {
        ...
        moduleConfig.addForwardConfig(new ActionForward("external", "http://jakarta.apache.org/", false, false));

        // Forward "foo" to "/bar.jsp"
        moduleConfig.addForwardConfig(new ActionForward("foo", "/bar.jsp", false, false));

        // Forward "relative1" to "relative.jsp" non-context-relative
        moduleConfig.addForwardConfig(new ActionForward("relative1", "relative.jsp", false, false));

        // Forward "relative2" to "relative.jsp" context-relative
        moduleConfig.addForwardConfig(new ActionForward("relative2", "relative.jsp", false, true));
        ...
        formBean.addFormPropertyConfig(new FormPropertyConfig("intArray1", "int[]", "{1,2,3}", 4)); // 4 should be ignored
        formBean.addFormPropertyConfig(new FormPropertyConfig("intArray2", "int[]", null, 5)); // 5 should be respected
        formBean.addFormPropertyConfig(new FormPropertyConfig("principal", "org.apache.struts.mock.MockPrincipal", null));
        formBean.addFormPropertyConfig(new FormPropertyConfig("stringArray1", "java.lang.String[]", "{aaa,bbb,ccc}", 2)); // 2 should be ignored
        formBean.addFormPropertyConfig(new FormPropertyConfig("stringArray2", "java.lang.String[]", null, 3)); // 3 should be respected
        moduleConfig.addFormBeanConfig(formBean);
        ...
        moduleConfig.addForwardConfig(new ForwardConfig("moduleForward", "/module/forward", false, false));
        moduleConfig.addForwardConfig(new ForwardConfig("moduleRedirect", "/module/redirect", true, false));
        moduleConfig.addForwardConfig(new ForwardConfig("contextForward", "/context/forward", false, true));
        moduleConfig.addForwardConfig(new ForwardConfig("contextRedirect", "/context/redirect", true, true));
        moduleConfig.addForwardConfig(new ForwardConfig("moduleNoslash", "module/noslash", false, false));
        moduleConfig.addForwardConfig(new ForwardConfig("contextNoslash", "context/noslash", false, true));
    ...
    protected void setUpSecondApp() {
        ...
        // Forward "external" to "http://jakarta.apache.org/"
        moduleConfig2.addForwardConfig(new ActionForward("external", "http://jakarta.apache.org/", false, false));

        // Forward "foo" to "/baz.jsp" (different from default)
        moduleConfig2.addForwardConfig(new ActionForward("foo", "/baz.jsp", false, false));

        // Forward "relative1" to "relative.jsp" non-context-relative
        moduleConfig2.addForwardConfig(new ActionForward("relative1", "relative.jsp", false, false));

        // Forward "relative2" to "relative.jsp" context-relative
        moduleConfig2.addForwardConfig(new ActionForward("relative2", "relative.jsp", false, true));
        ...
        // Configure global forward declarations
        moduleConfig2.addForwardConfig(new ForwardConfig("moduleForward", "/module/forward", false, false));
        moduleConfig2.addForwardConfig(new ForwardConfig("moduleRedirect", "/module/redirect", true, false));
        moduleConfig2.addForwardConfig(new ForwardConfig("contextForward", "/context/forward", false, true));
        moduleConfig2.addForwardConfig(new ForwardConfig("contextRedirect", "/context/redirect", true, true));
        moduleConfig2.addForwardConfig(new ForwardConfig("moduleNoslash", "module/noslash", false, false));
        moduleConfig2.addForwardConfig(new ForwardConfig("contextNoslash", "context/noslash", false, true));
    ...
    protected void setUpThirdApp() {
        ...
        // Configure global forward declarations
        moduleConfig3.addForwardConfig(new ForwardConfig("moduleForward", "/module/forward", false, false));
        moduleConfig3.addForwardConfig(new ForwardConfig("moduleRedirect", "/module/redirect", true, false));
        moduleConfig3.addForwardConfig(new ForwardConfig("contextForward", "/context/forward", false, true));
        moduleConfig3.addForwardConfig(new ForwardConfig("contextRedirect", "/context/redirect", true, true));
        moduleConfig3.addForwardConfig(new ForwardConfig("moduleNoslash", "module/noslash", false, false));
        moduleConfig3.addForwardConfig(new ForwardConfig("contextNoslash", "context/noslash", false, true));
    }
    ...
    public void testUtilBaseEnvironment() {
        ...
        assertEquals("request-->principal", principal, request.getUserPrincipal());
        ...
        assertEquals("context-->moduleConfig", moduleConfig, context.getAttribute(Globals.MODULE_KEY));

        // Validate the configuration for the second module
        assertNotNull("moduleConfig2 is present", moduleConfig2);
        assertEquals("context-->moduleConfig2", moduleConfig2, context.getAttribute(Globals.MODULE_KEY + "/2"));
